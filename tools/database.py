...
GET_ORDER_SCHEMA = {
    ...
    "function": {
        ...
        "description": "Look up a customer order by its id (format ORD-XXXX). "
                       "Returns status, dates, region, an optional free-text "
                       "notes field, and line items with quantities and unit "
                       "prices.",
        "parameters": {
            "type": "object",
            "properties": {
...
FIND_PRODUCTS_SCHEMA = {
    ...
    "function": {
        ...
        "description": "Search the product catalog by category, with optional "
                       ...
                       "price, units in stock, and a short product description.",
        "parameters": {
            "type": "object",
            "properties": {
...
def find_products(category: str, max_price: float | None = None,
    ...
    sql, args = ("SELECT sku, name, category, price, stock, description "
